 ...
 * This class used to POST to Jenkins for building related job with parameter
 *
 */
public class TestPreemptive {
	...
	public static void main(String[] args) {
		...
		// Jenkins url
		String jenkinsUrl = "http://10.1.130.68:8080";

		// Build name
		String jobName = "OracleFormsOperaDEV";

		// Build token
		String buildToken = args[0];
		...
		String getUrl = jenkinsUrl + "/job/" + jobName + "/buildWithParameters?PARAMETER=" + buildToken;
